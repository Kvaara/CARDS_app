...
func newDeck() deck {
	...
	cardValues := deck{"Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten", "Jack", "Queen", "King", "Ace"}
...
// This method shuffles the corresponding deck's cards.
func (d deck) shuffle() {
	...
	for index, _ := range d {
		deckLength := len(d)
		newPosition := numberGenerator.Intn(deckLength - 1)
